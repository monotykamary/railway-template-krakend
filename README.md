...
Deploy KrakenD Community Edition 2.13.10 with a working private backend example and a version-controlled gateway configuration.

The Deploy on Railway button is added after the published route is verified.

## What this deploys

- Public KrakenD CE `2.13.10`, pinned to the official Linux/AMD64 image digest
...
- Release: https://github.com/krakend/krakend-ce/releases/tag/v2.13.10
